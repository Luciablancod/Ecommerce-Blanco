            ...
            <footer class="py-3 py-md-4 py-xl-5 ">
                    ...
                    <div class="container">
                        <div class="row gy-3">
                            ...
                            <div class="col-6 col-md-3">
                                <div class="link-wrapper">
                                    <h4 class="mb-3 fw-bold fs-6">Acerca de</h4>
                            ...
                            <div class="col-6 col-md-3">
                                <div class="link-wrapper">
                                    <h4 class="mb-3 fw-bold fs-6">Otros sitios</h4>
                                    <ul class="m-0 list-unstyled">
                                        <li class="mb-1">
                                            <a href="#!" class="link-underline-opacity-0 link-opacity-75-hover link-underline-opacity-100-hover link-offset-1 link-secondary">
                                                Developers
                            ...
                            <div class="col-6 col-md-3">
                                <div class="link-wrapper">
                                    <h4 class="mb-3 fw-bold fs-6">Ayuda</h4>
                                    <ul class="m-0 list-unstyled">
                                        <li class="mb-1">
                                            <a href="#!" class="link-underline-opacity-0 link-opacity-75-hover link-underline-opacity-100-hover link-offset-1 link-secondary">
                                                Comprar
                            ...
                            <div class="col-6 col-md-3">
                                <div class="link-wrapper">
                                    <h4 class="mb-3 fw-bold fs-6">Mercado Puntos</h4>
                                    <ul class="m-0 list-unstyled">
                                        <li class="mb-1">
                                            <a href="#!" class="link-underline-opacity-0 link-opacity-75-hover link-underline-opacity-100-hover link-offset-1 link-secondary">
                                               Nivel 6
                ...
                <div>
                    <div class="container border-top pt-3 pt-md-4">
                        <div class="row">
                            <div class="col-12">
                                <div class="copyright-wrapper  text-secondary mb-1 fs-7 text-center">
