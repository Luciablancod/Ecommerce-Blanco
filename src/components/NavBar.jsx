                        ...
                        <div className="row">
                            ...
                            <div className="col-md-4 position-absolute end-0">
                                ...
                                <ul className="navbar-nav ">
                                    <li className="nav-item">
                                        <NavLink to={"/category/ofertas"} className="nav-link  pt-3" >Creá tu cuenta</NavLink>
                                    </li>
                                    <li className="nav-item">
                                        <NavLink to={"/category/ofertas"} className="nav-link  pt-3" >Ingresá</NavLink>
                                    </li>
                                    <li className="nav-item">
                                        <NavLink to={"/category/ofertas"} className="nav-link  pt-3" >Mis compras</NavLink>
                                    </li>
                                    <li className="nav-item">
                                        <NotificationWidget />
                                    </li>
